...
const phrases = [
  ...
  { text: "The documentary provided a comprehensive overview of environmental challenges.", translation: "O documentário deu uma visão geral completa dos desafios ambientais.", level: "B2" },
...
async function seed() {
  ...
  console.log(`   ${added} frases adicionadas`)
  console.log(`   ${skipped} frases já existiam`)
  console.log(`   ${wordsAdded} palavras adicionadas`)
  
  const totalPhrases = await prisma.phrase.count()
  const totalWords = await prisma.word.count()
  console.log(`   Total: ${totalPhrases} frases, ${totalWords} palavras no banco`)
